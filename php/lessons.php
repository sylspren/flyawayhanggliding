...
<div class="content">
  <div class="row">
    <div class="col-sm-5">
      <img class="fullwidth" src="fafiles/Anaiya.jpeg"/>
    </div>
    <div class="col-sm-6 offset-sm-1">
      <p>Fly Away Hang Gliding provides all of the necessary equipment that you will need to learn to fly. Hang gliding lessons will run 3 or more hours with many flights. </p>
      <p>
  ...
  <div class="row">
    <div class="col">
      ...
      a video of yourself right there on the hill after the flight helps you learn more quickly.
  ...
  <div class="row">
    ...
    <div class="col-sm-5 offset-sm-1">
      <img class="fullwidth" src="fafiles/bratcry1.jpg" alt="driving glider back up hill"/>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col">
      ...
      <ul>
        <li>The minimum weight is 80 pounds.</li>
        <li>The maximum weight is 350 pounds.</li>
        <li>You must be able to pick up 40 pounds and jog at least 5 MPH.</li>
      </ul>
      <p> It's warm and
        sunny here in Santa Barbara year round, and we have fresh, clean, smog-free air.
         The weather is good for learning to fly year
round, unless it's actually raining. </p>
      <div class="mx-auto" style="max-width:800px;">
        <img class="fullwidth" src="fafiles/thill_lz1.jpg" alt="looking from the landing area to top of hill"/>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-5">
      <img class="fullwidth" src="fafiles/thill_flying_far2.jpg" alt="student flying off top of training hill"/>
    </div>
    <div class="col-sm-6 offset-sm-1">
      <p>
